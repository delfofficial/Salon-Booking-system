...
<body>
    <div class="banner">
    <?php
    $sql = "SELECT * FROM services WHERE service_name ='Wigs and extensionsions'";
    ...
    ?>
        ...
        <div class="row">
            ...
            <div class="col-md-4 descrip">
                ...
                <p class="price align-center text-center"> From <i><?php echo $price; ?> KES</i></p>
                <button class="btn btn-warning nt2"><a href="booking.php">Book now</a></button>
